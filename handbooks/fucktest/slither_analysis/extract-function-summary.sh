...
echo -e "${BLUE}=== BakerFi 函数摘要提取工具 ===${NC}\n"

# 切换到项目根目录
cd "$(dirname "$0")/../../.."
PROJECT_ROOT=$(pwd)
OUTPUT_DIR="handbooks/fucktest/slither_analysis/function-summary"
...
OUTPUT_FILE="${OUTPUT_DIR}/function-summary-${TIMESTAMP}.txt"

echo -e "${YELLOW}📋 生成函数摘要...${NC}"
echo ""

# 运行 function-summary printer
slither . \
